	...
	jQuery(function($){
		$(document.body).on('click', '.quick_view_btn', function(e) {
			...
			$.getJSON( $(this).attr( 'href' ) + '.js', function( product ) {
				...
				$.getScript( "//cdn.shopify.com/s/assets/themes_support/option_selection-fe6b72c2bbdd3369ac0bfefe8648e3c889efca213baefd4cfb0dd9363563831f.js", function() {
	...
	function ajaxCartRender() {
		...
		jQuery.getJSON('/cart.js', function(data) {
			...
			if ( data.items.length == 0 ) {
				...
				newHtml += '<div class="box_footer"><p class="cart_total"><b>' + theme.cartAjaxTextTotalPrice + ': </b><span class="money">' + Shopify.formatMoney(data.total_price, theme.moneyFormat)  + '</span></p><a id="clear_cart_all_items" class="cart_clear" href="/cart/clear"><i class="fa fa-refresh" title="' + theme.cartAjaxTextClearCart + '"></i></a><a class="btn btn_alt" href="/checkout">Checkout</a><a class="btn" href="/cart">' + theme.cartAjaxTextGoCart + '</a></div>';
...
// PRODUCT PRICE COLLECTION SORT
// $('.template-collection').each(function(){
// 	var sort_min = $('.irs-from').html();
// 	var sort_max = $('.irs-to').html();



// 	$('.price_filter_btn').on('click', function(){
// 		sort_min = $('.irs-from').html();
// 		sort_max = $('.irs-to').html();


// 		$('.product_item_wrap').each(function(){
// 			var prod_price_min = $(this).data('price-min');
// 			var prod_price_max = $(this).data('price-max');
			
// 			if (sort_min > prod_price_max || sort_max < prod_price_min) {
// 				$(this).addClass('hidden_prod');
// 			} else {
// 				$(this).removeClass('hidden_prod');
// 			}
...
// $('.custom_pagination_list').each(function(i) {
// 	var container = $(this);
// 	container.pagination({
// 	    dataSource: function(done){
// 		  	var result = [];
// 		  	$('.product_item_wrap').each(function() {
// 		  		var prod_p = $(this).data('paginated');
// 				result.push(prod_p);
...
// 		  	done(result);
// 		},
// 		pageSize: $(this).data('paginate-by'),
	    
// 	    callback: function(data, pagination) {
// 	        var cont = $('.custom_pagination_list').(data);
